...
export default function ShareButton({ sessionId }: { sessionId: string }) {
  ...
  return (
    <button
      type="button"
      onClick={share}
      className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-full text-sm font-semibold bg-[image:var(--brand-grad)] text-white shadow-[var(--shadow-md)] hover:brightness-105 active:scale-[0.98] clay-press transition-all duration-200"
    >
